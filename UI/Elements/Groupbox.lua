...
function UI:CreateGroupBox(Settings)
    ...
    Groupbox.TitleBG:SetPoint("LEFT", BorderTopLeft, "LEFT", 15, 0)
    ...
    Groupbox.TitleBG:SetHeight(25)

    BorderTopLeft.Title = Groupbox.TitleBG:CreateFontString(UI:FrameName(Settings.Name)..".Title", "OVERLAY")
    BorderTopLeft.Title:SetPoint("LEFT", BorderTopLeft, "LEFT", 25, 0)
    BorderTopLeft.Title:SetFont(Assets.Fonts["Asap.ttf"], 12)
