...
Addon.Core.AddonName = "Loot Alarm"
Addon.Core.AddonNameShort = "LA"
...
Addon.Assets.Sounds = {}
Addon.Assets.Sounds["Bam.ogg"] =                        AssetsPath.."\\Sounds\\Bam.ogg"
Addon.Assets.Sounds["Baam.ogg"] =                       AssetsPath.."\\Sounds\\Baam.ogg"
...
Addon.Events1:RegisterEvent("GET_ITEM_INFO_RECEIVED")
Addon.Events1:RegisterEvent("LOOT_READY")
...
Addon.Events2:RegisterEvent("GET_ITEM_INFO_RECEIVED")
Addon.Events2:RegisterEvent("GET_ITEM_INFO_RECEIVED")
Addon.Events2:RegisterEvent("LOOT_READY")
Addon.Events2:RegisterEvent("EQUIP_BIND_CONFIRM")
